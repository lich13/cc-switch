      ...
      {visibleList.map((app) => {
        ...
        return (
          <button
            ...
            className={cn(
              "group inline-flex h-8 items-center rounded-md px-2 text-sm font-medium transition-all duration-200 sm:px-3",
              isActive
        ...
        <Popover open={moreOpen} onOpenChange={setMoreOpen}>
          <PopoverTrigger asChild>
            <button
              ...
              className={cn(
                "inline-flex h-8 items-center rounded-md px-2 transition-all duration-200 sm:px-3",
                moreOpen
                  ? "bg-background text-foreground shadow-sm"
                  : "text-muted-foreground hover:text-foreground hover:bg-background/50",
              )}
