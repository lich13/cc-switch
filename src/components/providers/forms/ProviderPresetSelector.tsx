...
export function ProviderPresetSelector({
  ...
  const availablePresetEntries = useMemo(
    () =>
      isWeb
        ? presetEntries.filter(
            (entry) =>
              (entry.preset as { providerType?: string }).providerType !==
              "xai_oauth",
          )
        : presetEntries,
    [isWeb, presetEntries],
  ...
  const visiblePresetEntries = useMemo(
    () =>
      getVisiblePresetEntries(availablePresetEntries, {
        query: searchQuery,
        sortMode,
        t,
      }),
    [availablePresetEntries, searchQuery, sortMode, t],
  );
