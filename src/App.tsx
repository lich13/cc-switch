...
const getInitialApp = (): AppId => {
  ...
  const validApps = isWebRuntime() ? WEB_SAFE_APPS : APP_IDS;
...
function App() {
  ...
  const visibleApps = useMemo<VisibleApps>(() => {
    ...
    return isWeb
      ...
      : configuredVisibleApps;
  }, [isWeb, settingsData?.visibleApps]);

  const getFirstVisibleApp = (): AppId => {
    const candidates = isWeb ? WEB_SAFE_APPS : APP_IDS;
    return candidates.find((app) => visibleApps[app]) ?? "codex";
  };
