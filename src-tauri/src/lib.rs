    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            // 初始化 CopilotAuthManager
            {
                ...
                let manager = app.state::<AppState>().managed_auth.copilot.clone();
                app.manage(CopilotAuthState(manager));
            ...
            // 初始化 CodexOAuthManager (ChatGPT Plus/Pro 反代)
            {
                ...
                let manager = app.state::<AppState>().managed_auth.codex_oauth.clone();
                app.manage(CodexOAuthState(manager));
